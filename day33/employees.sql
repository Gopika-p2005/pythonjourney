...
-- display firstname,email of all employee

select first_name,email from employee;

-- display firstname and salary of all employee
...
-- display employee whose job_title = developer
...
select * from employee where job_title = "Manager" and salary >70000;

-- display employee details where job_title either Manager or Developer

 select * from employee where job_title ="Manager" or job_title="Developer";
 
 -- display job_title (cannot duplicat)

 select distinct job_title from employee;
 
-- display employee whose job_title not equal to Manager

select * from employee where job_title!="Manager";
-- select * from employee where not job_title ="Manager"(another method)
...
-- employee with second highest slary
...
-- display employee whose salary in range of 60 to 75
...
select count(*) as emplo_count from employee;
...
select avg(salary) as avg_sa from employee;
...
-- departrment with most number of salary

select department, count(*) as count from employee group by department order by count desc limit 1;

-- departme with  most number of salary

select department ,count(*) as count from employee group by department order by count asc limit 1;

-- department with morthan 3 employee
...
select * from employee where first_name like"%r"; -- ends with r

select * from employee where first_name like"%ar%"; -- contains
