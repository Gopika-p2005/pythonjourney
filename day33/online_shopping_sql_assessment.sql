...
select * from product where brand="apple" and price>50000;
-- Q12. Display Samsung products with rating above 4.5.
select * from product where brand="samsung" and rating>4.5;
...
select * from product where not brand="apple";
...
select * from product where created_date between '2024-03-01' and '2024-05-31';
...
select * from product where price not between 20000 and 80000;
...
select * from product where product_name like '%tv';
-- Q25. Display products whose brand contains 'o'.
select * from product where brand like '%o%';
...
select * from product order by price desc limit 1 offset 2;
...
select sum(stock) as stock_sum from product;
...
select sum(price * stock) as inventory_value from product;
...
select brand,count(*) as count from product group by brand;
...
select category,max(price) as highest_price from product group by category;
...
select category ,count(*) as count from product group by category having count>2;
-- Q48. Display brands having more than 1 product.
select brand ,count(*) as count from product group by brand having count>1;
-- Q49. Display categories whose average price is greater than 30000.
select category ,avg(price) as avg_price from product group by category having avg_price >30000;
-- Q50. Display brands whose total stock exceeds 20.
select brand,sum(stock) as total_stock from product group by brand having total_stock >20;
...
select brand,count(*) as count from product group by brand order by count desc limit 1;
-- Q53. Which category has the least products?
select category ,count(*) as count from product group by category order by count asc limit 1;
...
select category ,max(stock) as max_stock from product group by category order by max_stock desc limit 1;
